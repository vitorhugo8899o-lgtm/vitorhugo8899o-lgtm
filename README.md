...
**Desenvolvedor Backend em formação com foco em Python e APIs de alta performance.**

Atualmente curso **Análise e Desenvolvimento de Sistemas** e dedico meu tempo à construção de arquiteturas escaláveis, utilizando **FastAPI** e bancos de dados relacionais para resolver problemas reais.
